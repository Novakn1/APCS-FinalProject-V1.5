...
public class Boss extends Character
{
   private int direction;
    ...
    public Boss(int health, int attack, int defense){
    ...
    if (getHealth()<0){
        Potion potion = new Potion(50,50,50);
     ...
     */public void getExcited(int range){
        ...
        GreenfootImage[] anim = {new GreenfootImage("boss1.png"), new GreenfootImage("boss2.png"),
        new GreenfootImage("boss3.png"), new GreenfootImage("boss4.png"), new GreenfootImage("boss5.png")};
